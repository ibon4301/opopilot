/**
 * Contrato provider-agnostic de generación de flashcards: el servicio
 * depende de esta interfaz, nunca de un proveedor concreto. Cambiar de
 * proveedor = añadir un archivo que implemente GenerateFlashcardsFn.
 */
 ...
 */
export type GenerateFlashcardsFn = (prompt: string) => Promise<string>;
